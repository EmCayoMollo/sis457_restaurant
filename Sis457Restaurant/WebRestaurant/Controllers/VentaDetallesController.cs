...
namespace WebRestaurant.Controllers
{
    public class VentaDetallesController : Controller
    {
        ...
        public VentaDetallesController(FinalRestaurantContext context)
        {
            _context = context;
        }
        ...
        {
            var finalRestaurantContext = _context.VentaDetalles.Include(v => v.IdPlatilloNavigation).Include(v => v.IdRefrescoNavigation).Include(v => v.IdVentaNavigation);
            return View(await finalRestaurantContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ventaDetalle = await _context.VentaDetalles
                ...
                .Include(v => v.IdRefrescoNavigation)
        ...
        {
            ViewData["IdPlatillo"] = new SelectList(_context.Platillos, "Id", "Id");
            ViewData["IdRefresco"] = new SelectList(_context.Refrescos, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,IdVenta,IdPlatillo,IdRefresco,Cantidad,TotalVentaDetalle,UsuarioRegistro,FechaRegistro,Estado")] VentaDetalle ventaDetalle)
        {
            ...
            ViewData["IdPlatillo"] = new SelectList(_context.Platillos, "Id", "Id", ventaDetalle.IdPlatillo);
            ViewData["IdRefresco"] = new SelectList(_context.Refrescos, "Id", "Id", ventaDetalle.IdRefresco);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdVenta,IdPlatillo,IdRefresco,Cantidad,TotalVentaDetalle,UsuarioRegistro,FechaRegistro,Estado")] VentaDetalle ventaDetalle)
        {
