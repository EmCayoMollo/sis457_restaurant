...
namespace WebRestaurant.Controllers
{
    public class VentasController : Controller
    {
        ...
        {
            var finalRestaurantContext = _context.Venta.Include(v => v.IdClienteNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCliente,TipoServicio,Total,Efectivo,Cambio,UsuarioRegistro,FechaRegistro,Estado")] Ventum ventum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdCliente,TipoServicio,Total,Efectivo,Cambio,UsuarioRegistro,FechaRegistro,Estado")] Ventum ventum)
        {
            if (id != ventum.Id)
            {
                return NotFound();
