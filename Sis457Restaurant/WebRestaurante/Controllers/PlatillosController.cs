...
namespace WebRestaurante.Controllers
{
    public class PlatillosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Codigo,Nombre,Precio,UsuarioRegistro,FechaRegistro,Estado")] Platillo platillo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Codigo,Nombre,Precio,UsuarioRegistro,FechaRegistro,Estado")] Platillo platillo)
        {
            if (id != platillo.Id)
            {
                return NotFound();
